...
import 'package:admin_portal/models/student.dart';
...
Future<void> calculateMeritList() async {
  ...
  students.sort((a, b) {
    ...
    int aExtraSubject =
        a.maths + a.science + a.english + a.socialScience + a.gujrati;
    int bExtraSubject =
        b.maths + b.science + b.english + b.socialScience + b.gujrati;
  ...
  for (int i = 0; i < students.length; i++) {
    ...
    student.meritNo = currentRank;
    await studentRef.doc(students[i].uid).update({"meritNo": currentRank});
  }
